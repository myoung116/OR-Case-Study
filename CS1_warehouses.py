...
### Importing Data--------------------------------------------------------------------------
df_plants = pd.read_excel('/Users/michaelyoung/Documents/Decision Spot/Case Study 1/dat/CS1.xlsx', sheet_name='Plants')
df_custs = pd.read_excel('/Users/michaelyoung/Documents/Decision Spot/Case Study 1/dat/CS1.xlsx', sheet_name='Customers')
df_prods = pd.read_excel('/Users/michaelyoung/Documents/Decision Spot/Case Study 1/dat/CS1.xlsx', sheet_name='Product')
df_demands = pd.read_excel('/Users/michaelyoung/Documents/Decision Spot/Case Study 1/dat/CS1.xlsx', sheet_name='Demand')
df_caps = pd.read_excel('/Users/michaelyoung/Documents/Decision Spot/Case Study 1/dat/CS1.xlsx', sheet_name='Production Capacity')
df_dists = pd.read_excel('/Users/michaelyoung/Documents/Decision Spot/Case Study 1/dat/CS1.xlsx', sheet_name='Distances')
df_changes = pd.read_excel('/Users/michaelyoung/Documents/Decision Spot/Case Study 1/dat/CS1.xlsx', sheet_name='Setups')
